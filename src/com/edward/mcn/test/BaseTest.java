...
public class BaseTest {
	...
	public void testForOutOfBounds() {
		...
		assertThat(digit.toString(), is("THAT NUMBER IS OUT OF BOUNDS!"));
		assertThat(digit2.toString(), is("THAT NUMBER IS OUT OF BOUNDS!"));
		assertThat(digit3.toString(), is("THAT NUMBER IS OUT OF BOUNDS!"));
		assertThat(digit4.toString(), is("THAT NUMBER IS OUT OF BOUNDS!"));
		assertThat(digit.toRomanNumeral(), is("THAT NUMBER IS OUT OF BOUNDS!"));
		assertThat(digit2.toRomanNumeral(), is("THAT NUMBER IS OUT OF BOUNDS!"));
		assertThat(digit3.toRomanNumeral(), is("THAT NUMBER IS OUT OF BOUNDS!"));
		assertThat(digit4.toRomanNumeral(), is("THAT NUMBER IS OUT OF BOUNDS!"));
	}
}
